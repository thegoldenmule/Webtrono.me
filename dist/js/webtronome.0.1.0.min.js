...
var __buildTimestamp="140924160500-0500";"use strict";function Daemon(oOwner,fTask,nRate,nLen,fInit,fOnstart){if(!(this&&this instanceof Daemon)){return;}
...
var duration=this._pausedTime-this._startTime;this._pausedTime=null;this._startTime=Date.now()-duration;this._daemon.play();},stop:function(){this._daemon.pause();this._startTime=null;this._pausedTime=null;this._totalTime=null;this._tick();this.Stopped.dispatch();},_tick:function(){if(null===this._startTime){this._timerBar.progressbar('value',0);$('#timer-label').text('00:00:000');}else{var timeElapsed=Date.now()-this._startTime;if(timeElapsed>this._totalTime){this.stop();this._metronome.pause();this.Ended.dispatch();}else{this._timerBar.progressbar('value',timeElapsed/this._totalTime*100);$('#timer-label').text(parseTime(this._totalTime-timeElapsed));}}}};})(this);(function(global){"use strict";global.VisualizerView=function(metronome){var color='#FFFFFF';metronome.Ticked.add(function(){$('body').animate({'backgroundColor':color},50,"swing",function(){$('body').animate({'backgroundColor':'#ffffff'},100);});});$('.vs-button').click(function(event){color=$(event.target).css('background-color');});};global.VisualizerView.prototype={constructor:global.VisualizerView};})(this);(function(global){"use strict";var main=function(){var scope=this;this.metronome=new Metronome();var playback=new PlaybackView(this.metronome);var timer=new TimerView(this.metronome);var timerCurve=new TimerCurveView(this.metronome,timer);var visualizer=new VisualizerView(this.metronome);var audio=new AudioView(this.metronome,timer);$(document).keyup(function(event){if(27===event.which){scope.metronome.pause();}});return scope;};$(document).ready(main);})(this);